                    ...
                    <div class="card-body bg-light">
                         ...
                         <form action="" method="post">
                              <div class="form-group ">
                                   ...
                                   <input type="text" name="code_etudiant" class="form-control" placeholder="Code élève" required>
                              </div>
                              <div class="form-group ">
                              ...
                              <div class="form-group ">
                                   ...
                                   <input type="date" name="naiss" class="form-control" placeholder="Date de naissance" required>
                              </div>
                              <div class="form-group ">
